...
@Entity
@Cacheable
@Table(name = "product_to_attr_combination")
@JsonAutoDetect(fieldVisibility = JsonAutoDetect.Visibility.NONE,
        getterVisibility = JsonAutoDetect.Visibility.NONE,
        setterVisibility = JsonAutoDetect.Visibility.NONE
)
@JsonIgnoreProperties(ignoreUnknown = true)
public class ProductAttrCombination extends AbstractIdentity {
    /*
    CAUTION! THIS TABLE IS NEEDED, IT DOESNT WORK AS MANY TO MANY RELATIONSHIP, SINCE WE NEED ID OF THE RECORD TO
    USE IT AS GROUP AND ADD TO IT IMAGE
     */
    /*
    attribute
    |ID|NAME     |
