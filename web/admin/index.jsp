...
<%
    ...
    if(sh.getUser()!=null || sh.shopSettings.isMissingData()){
%>
<!DOCTYPE html>
...
<div class="page-wrapper">
    <%if(!sh.shopSettings.isMissingData()){%>
    ...
    <div class="page-container">
        ...
        MergeResult mr = null;
        if(sh.shopSettings.isMissingData()){
            System.out.println("I do miss data");
            if(request.getParameter("shop-settings-process")!=null) {
                mr = ShopSettingsBean.merge(request,session);
                ...
                %><jsp:include page="src/_view/shop-settings/list.jsp"/><%
            }
        }else if(sh.getUser()!=null){%>
            <jsp:include page="src/_main/sidebar.jsp"/>
            <%

            if("shop-settings".equals(entName) ){
