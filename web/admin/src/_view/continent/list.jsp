...
<%
    ...
    Class className = Continent.class;
    List<Continent> list = sh.getJPA().selectAllByID(className);
            ...
            <div class="col-md-12">
                ...
                <div ><%--class="portlet light bordered">--%>
                        ...
                        <table class="table table-striped table-bordered table-hover order-column" id="sample_1_donotinit">
                            ...
                            <tbody>
                            <%
                                for(Continent o : list){
                                    ContinentLang ol = o.getLang(sh.shopSettings.defaultLanguage,sh.jpa);
                                    %>
                                    <tr class="odd gradeX">
                                        <td>
                                            <%=o.getId()%>
