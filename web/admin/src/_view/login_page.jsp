...
<head>
    ...
    <link href="/modules/backend_metronic-4.7.1/assets/pages/css/login.min.css" rel="stylesheet" type="text/css" />
...
<script src="/modules/backend_metronic-4.7.1/assets/pages/scripts/login.min.js" type="text/javascript"></script>
