...
<%
    ...
    List<OrderState> list = sh.getJPA().selectAllByID(className);
...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title"> Druhy stavů objednávek
            <small></small>
            ...
            <div class="col-md-12">
                ...
                <div ><%--class="portlet light bordered">--%>
                        ...
                        <table class="table table-striped table-bordered table-hover order-column" id="sample_1_donotinit">
                            ...
                            <tbody>
                            <%
                                for(OrderState o : list){
                                    OrderStateLang ol = o.getLang(sh.shopSettings.defaultLanguage,sh.jpa);
                                    %>
                                    <tr class="odd gradeX">
                                        <td>
                                            <%=o.getId()%>
