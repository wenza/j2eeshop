                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        %>
                                        <input name="categories" value="<%=categories%>" style="display:none;"/>
                                            ...
                                            for(ProductImage pi : pis){
                                                ...
                                                <div class="multi-img">
                                                    <div class="multi-img-image" style="background-image:url('<%=pi.getImageURL()%>');">
                                                        <%
                                                        if(!pi.isCover()){
                                                            %><input type="text" name="img-url-1" value="<%=pi.getImageURL()%>" style="display:none;"><%
                                                        }
                                                        %>
                                                    </div>
                                                    <%
                                                    if(pi.isCover()){
                                                        %>
                                                        <div class="iscover">Cover<input type="text" name="img-url-1-cover" value="<%=pi.getImageURL()%>" style="display:none;"/></div>
                                                        <%
                                                    }
                                                    %>
                                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="supplier-price" name="supplier-price" class="form-control" value="<%=entity!=null?entity.getSupplierPrice():0%>">
                                            <span class="input-group-addon"><%=sh.shopSettings.defaultCurrency.getIsoCode()%></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="supplier-price-tax-id" class="form-control select2" name="supplier-price-tax-id">
                                            ...
                                            for(Tax tax : sh.jpa.selectAllByID(Tax.class)){
                                                ...
                                                boolean selected = false;
                                                if(entity!=null){
                                                    if(entity.getSupplierTax()!=null) {
                                                        if (entity.getSupplierTax().getId() == tax.getId()) selected = true;
                                                    }
                                                }else {
                                                    if (tax.getId() == sh.shopSettings.defaultTax.getId())selected = true;
                                                }
