                ...
                <div class="form-body row seo" >
                    <div class="">
                        ...
                        <div class="">
                            <div class="col-md-6">
                        <%
                            //String templatePath = sh.shopSettings.getWarPath()+"/modules/mailtemplate-editor/templates/universal/mailtemplate.html";
                            //String template = MailContent.readFile(templatePath, StandardCharsets.UTF_8);
                            Properties main = PropertyHandler.read(sh.shopSettings.getWarPath()+"/modules/mailtemplate-editor/templates/universal/mailtemplate.properties");
                            Properties lang = PropertyHandler.read(sh.shopSettings.getWarPath()+"/modules/mailtemplate-editor/templates/universal/mailtemplate-lang.properties");
                            Properties val = PropertyHandler.read(sh.shopSettings.getWarPath()+"/modules/mailtemplate-editor/template-values/template-values-test.properties");
