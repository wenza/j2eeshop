var RevSliderEditor = function () {
    ...
    var openElementEdit = function(el){
        ...
        if(el.attr('type')=='text') {
            ...
            $('textarea[name="content-two"]').val(el.html());
            CKEDITOR.instances.textcontentckedittwo.setData(el.html());
